 ...
 */
var somePlace = GPS()
print(somePlace.latitide)
print(somePlace.longitude)

/*:
 Change `somePlace`'s latitude to 51.514004, and the longitude to 0.125226, then print the updated values.
 */
somePlace.latitide = 51.514004
somePlace.longitude = 0.0125226
print(somePlace.latitide)
print(somePlace.longitude)
...
favoriteBook.title = "Into the Wild"
favoriteBook.author = "John Krakauer"
favoriteBook.pages = 240
favoriteBook.price = 11.89
