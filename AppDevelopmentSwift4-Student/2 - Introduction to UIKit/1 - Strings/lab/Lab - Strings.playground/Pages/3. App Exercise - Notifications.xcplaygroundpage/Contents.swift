 ...
 */
let firstName:String = "Mondale"
let lastName:String = "Felix"
...
let congratulations:String = "\(fullName)! You beat your previous daily high score of \(previousBest) steps by walking \(newBest) steps yesterday! That is a difference of \(newBest - previousBest) steps! Good job!"
